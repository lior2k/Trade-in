...
import { widthBreakPoints } from '../../constants/constants';
...
const FloatingButtons = () => {
	...
	const visibility = dimensions.width > widthBreakPoints.MOBILE;
	return (
		<>
			{visibility && (
							...
							<div className='contacts-popup-window'>
								...
								<div className='section lower'>
									...
									<div className='flex-row-container'>
										<span className='sub-text contact-info'>
											טלפון: 050-5277127, 050-5300554
										</span>
									</div>
								</div>
							</div>
